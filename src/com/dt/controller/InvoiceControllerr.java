...
import com.dt.beans.BillingBean;
import com.dt.beans.ProductBean;
import com.dt.utils.Alert;
import com.dt.utils.InvoiceGenerator;
import com.dt.utils.ValidationFields;
...
public class InvoiceControllerr implements Initializable{
	...
	public void printBill(ActionEvent event) {
		...
		File file =new File("resources/output/INVOICE.pdf");
		boolean isGenrated =false;
		BillingBean bean = checkBilling(event);
