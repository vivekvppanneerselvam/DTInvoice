...
//import com.dt.animations.FadeInLeftTransition;
//import com.dt.animations.FadeInLeftTransition1;
//import com.dt.animations.FadeInRightTransition;
import com.dt.config.Config;
import com.dt.dao.DAOUser;
...
//        Platform.runLater(() -> {
//            new FadeInRightTransition(lblUserLogin);
    ...
    private void actionLogin(ActionEvent event) {
        {
            ...
            if (checkUser(userName, passWord)) {
                ...
                Config c = new Config();
                c.newStage(stage, lblClose, "/com/dt/view/Home.fxml", "",
                        true, StageStyle.DECORATED, true);
