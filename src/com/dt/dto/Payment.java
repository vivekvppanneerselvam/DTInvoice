...
public class Payment {
    ...
    public void setPaymentMode(PaymentMode value) {
        if (value == null) {
            throw new IllegalArgumentException("Payment Mode can't be assigned a null value.");
        }
    ...
    public void setCustomer(Customer value) {
        if (value == null) {
            throw new IllegalArgumentException("Customer can't be assigned a null value.");
        }
    ...
    public void setPaymentDate(LocalDate value) {
        if (value == null) {
            throw new IllegalArgumentException("Payment date can't be null.");
        }
