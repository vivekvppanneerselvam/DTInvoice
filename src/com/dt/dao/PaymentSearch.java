...
public class PaymentSearch {
    ...
    private final static Logger logger = 
            Logger.getLogger(PaymentSearch.class.getName());
    
    public static List<PaymentSearchResult> searchPayments(PaymentSearchCriteria criteria)
            throws SQLException {
        ...
        try {
            ...
            try(Statement s = connection.createStatement()) {
                try(ResultSet rs = s.executeQuery(sql)) {
                    ...
                    while (rs.next()) {
                        ...
                        if (result.getPaymentMode() == PaymentMode.CHEQUE ||
                                result.getPaymentMode() == PaymentMode.DD) {
           ...
           logger.logp(Level.SEVERE, PaymentSearch.class.getName(),
                    "searchPayments", "Error in searching the payments", e);
            throw e;
        }
        return results;
    }
    ...
    private static String getQuerySQL(PaymentSearchCriteria criteria) {
        ...
        sql.append("SELECT p.*, pd.amountrealised, c.name ")
        ...
        if (criteria.getStartDate() != null) {
            ...
            sql.append(" WHERE p.paymentdate BETWEEN '")
                    .append(startDate.format(formatter)).append("' AND '")
    ...
    public static void deletePayment(int paymentId) throws SQLException {
        ...
        try {
           ...
           logger.logp(Level.SEVERE, PaymentSearch.class.getName(),
                    "deletePayment", "Error in deleting the payment", e);
            throw e;
        }
    }
