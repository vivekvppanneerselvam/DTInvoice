...
public class InvoiceSearch {
    ...
    private final static Logger logger = 
            Logger.getLogger(InvoiceSearch.class.getName());
    
    public static List<InvoiceSearchResult> searchInvoice(InvoiceSearchCriteria criteria) 
        throws Exception{
        ...
        try {
            ...
            try(Statement s = connection.createStatement()) {
                try(ResultSet rs = s.executeQuery(sql)) {
                    ...
                    while (rs.next()) {
                       ...
                       result.setInvoiceDate(rs.getDate(2).toLocalDate());
            ...
            logger.logp(Level.SEVERE, InvoiceSearch.class.getName(),
                    "searchInvoice", "Error in getting the invoice list", e);
            throw e;
        }
    ...
    private static String getQuerySQL(InvoiceSearchCriteria criteria) {
        ...
        sql.append("SELECT id, invoicedate, name, city, invoice_total(id) ")
                .append("FROM invoices AS i LEFT JOIN Customers AS c ")
                .append("ON i.customerid = c.cust_id  WHERE ");
         ...
         if (criteria.getInvoiceNumber() != null) {
             ...
             if (criteria.getStartDate() != null) {
               ...
               sql.append("invoicedate BETWEEN '").append(startDateString) 
                       .append("' AND '").append(endDateString).append("' ");
             ...
             if (amount != null) {
                 ...
                 conditionApplied = true;
                 sql.append(" invoice_total(id) BETWEEN ")
                         .append(amount.toPlainString()).append(" AND ")
    ...
    public static void deleteInvoice(int invoiceNumber) throws Exception {
        ...
        try(PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            logger.logp(Level.SEVERE, InvoiceSearch.class.getName(),
                    "deleteInvoice", "Error in deleting the invoice", ex);
            throw ex;
        }
