...
public class DatabaseConnect {
    ...
    private static final String SQLCONN = "jdbc:sqlite:";

    public static Connection getConnection() throws SQLException {
    	//System.getenv("ProgramData");
    	String path = SQLCONN + System.getenv("ProgramData") + "\\dtinvoice.db";
    	 try {
    ...
    public static void connect(String sql) {
        try {
            ...
            conn = DriverManager.getConnection("jdbc:sqlite:dtinvoice.db");
...
/*
    ...
    public static List<User> connectWithQueryUser(String sql) {
        List<User> st = new ArrayList<>();
        try {
        	//conn = DriverManager.getConnection("jdbc:default:connection");
            //java.lang.Class.forName("org.sqlite.JDBC");
            conn = getConnection();
            //DriverManager.getConnection("jdbc:sqlite:dtinvoice.db");
            stmt = conn.createStatement();
            rs = stmt.executeQuery(sql);
            while (rs.next()) {
